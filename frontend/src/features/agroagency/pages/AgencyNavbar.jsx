...
export default function AgencyNavbar() {
  ...
  return (
    <>
      ...
      <header className="bg-[#28a745] text-white text-sm font-bold flex justify-between items-center p-4 top-12 z-1 fixed w-screen">
        {/* Logo Section */}
        <div
          ...
          {!isLoggedIn ? (
            ...
            <>
              ...
              <button
                ...
                className={`flex hover:text-gray-300 transition-colors ${
                  location.pathname === "/agroagency/dashboard"
                    ? "underline"
                    : ""
                }`}
              >
