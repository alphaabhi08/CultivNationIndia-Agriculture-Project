...
const AddressForm = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-4xl mx-auto mt-14 p-4 sm:p-6 md:p-8 bg-white shadow-2xl rounded-lg">
        <h2 className="text-2xl sm:text-3xl font-semibold mb-2 text-center text-gray-800">
        ...
        <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <input name="street" placeholder="Street Address" value={formData.street} onChange={handleChange} required className="border p-2 rounded w-full md:col-span-2" />
          ...
          <button type="submit" className="bg-green-600 text-white py-2 text-center font-semibold rounded hover:bg-green-700 transition md:col-span-2">
            Save Address
          </button>
        </form>
